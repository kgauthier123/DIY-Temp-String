...
// Print all temperature data to serial monitor if desired
...
if(SD.exists("data_a.csv")){
  Serial.println("File exists");
}
else{
  Serial.println("No file, writing new");
  sensorData = SD.open("data_a.csv", FILE_WRITE);
...
//--------------------------------------------------
void saveData(){
if(SD.exists("data_a.csv")){ // check the card is still there
